    ...
    <section class="w-full h-screen bg-white md:pl-[310px] p-[20px] pt-[100px]">
        ...
        <div>
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div
                    ...
                    <div class="relative">
                        <div
                            ...
                            <svg class="w-4 h-4 text-red-500 dark:text-red-400" aria-hidden="true"
                        ...
                        <input type="text" id="table-search-users"
                            class="block p-2 ps-10 text-sm text-red-900 border border-red-300 rounded-lg w-80 bg-red-50 focus:ring-red-500 focus:border-red-500 dark:bg-red-700 dark:border-red-600 dark:placeholder-red-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                ...
                <table class="w-full text-sm text-left rtl:text-right text-red-500 dark:text-red-400">
                    ...
                    <tbody>
                        <tr
                            class="bg-white border-b dark:bg-red-800 dark:border-red-500 border-red-200 hover:bg-red-500 dark:hover:bg-red  -600">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-table-search-1" type="checkbox"
                                        class="w-4 h-4 text-red-600 bg-red-100 border-red-300 rounded-sm focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-red-800 dark:focus:ring-offset-red-800 focus:ring-2 dark:bg-red-700 dark:border-red-600">
                            ...
                            <th scope="row"
                                ...
                                <div class="ps-3">
                                    ...
                                    <div class="font-normal text-red-300">neil.sims@flowbite.com</div>
                                </div>
                            </th>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <a href="#"
                                    class="font-medium text-red-600 dark:text-red-500 hover:underline">Edit user</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <nav class="flex items-center space-x-2">
                <a href="#"
                    class="px-3 py-1 text-sm font-medium text-red-700 bg-white border border-red-300 rounded-lg hover:bg-red-100 dark:bg-red-800 dark:text-red-400 dark:border-red-600 dark:hover:bg-red-700">Previous</a>
                <a href="#"
                    class="px-3 py-1 text-sm font-medium text-blue-600 bg-white border border-blue-600 rounded-lg hover:bg-blue-50 dark:bg-blue-800 dark:text-blue-500 dark:border-blue-600 dark:hover:bg-blue-700">1</a>
                <a href="#"
                    class="px-3 py-1 text-sm font-medium text-red-700 bg-white border border-red-300 rounded-lg hover:bg-red-100 dark:bg-red-800 dark:text-red-400 dark:border-red-600 dark:hover:bg-red-700">2</a>
                <a href="#"
                    class="px-3 py-1 text-sm font-medium text-red-700 bg-white border border-red-300 rounded-lg hover:bg-red-100 dark:bg-red-800 dark:text-red-400 dark:border-red-600 dark:hover:bg-red-700">3</a>
                <a href="#"
                    class="px-3 py-1 text-sm font-medium text-red-700 bg-white border border-red-300 rounded-lg hover:bg-red-100 dark:bg-red-800 dark:text-red-400 dark:border-red-600 dark:hover:bg-red-700">Next</a>
            </nav>
